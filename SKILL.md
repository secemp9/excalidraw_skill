...
description: Generate Excalidraw diagrams for Obsidian. Triggers when user asks to create an excalidraw diagram, flowchart, mind map, timeline, hierarchy chart, relationship map, comparison chart, matrix, or any visual representation. Also triggers on keywords like "visualize", "visual", "draw", "sketch", "diagram this", "map this out", "chart this". Outputs Obsidian-ready .md files with Excalidraw frontmatter and auto-saves to the current working directory.
---
